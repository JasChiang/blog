...
status: draft
excerpt: "身為 YouTube 創作者，我用 vibe coding 的方式，靠 Claude Code、Codex 和 Gemini CLI 從零打造了一套影片轉文章、自動中繼資料生成、頻道數據分析的一站式工具。"
tags:
  - ai-practice
---
...
**不同 AI 工具有不同的甜蜜點：**
- **Codex** 適合功能明確的任務，像是「幫我串 Notion API」這種有清楚規格的事情
- **Claude Code** 適合比較複雜、需要理解整個專案脈絡的開發，它會自己開分支、寫完整的功能模組
- **Gemini CLI** 適合批次處理，像是一次重寫所有文件
